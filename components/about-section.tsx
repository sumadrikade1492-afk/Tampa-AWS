        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              Tampa AWS Meetup is a vibrant community of cloud enthusiasts, developers, 
              architects, and tech professionals passionate about Amazon Web Services. 
              We gather monthly to share knowledge, explore new technologies, and build 
              lasting connections in the Tampa Bay tech ecosystem.
            </p>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Whether you&apos;re just starting your cloud journey or you&apos;re a seasoned 
              AWS expert, our meetup offers something for everyone. Join us for 
              hands-on workshops, insightful presentations, networking opportunities, 
              and the chance to learn from industry leaders.
            </p>
              ...
              <div className="absolute inset-4 bg-gradient-to-br from-aws-navy to-aws-navy/80 rounded-2xl flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-4 text-center">
                    <div>
                      <p className="text-xl font-bold text-aws-orange">50+</p>
                      <p className="text-sm text-white/60">Events</p>
                    </div>
                    <div>
                      <p className="text-xl font-bold text-aws-orange">100+</p>
                      <p className="text-sm text-white/60">Speakers</p>
                    </div>
                  </div>
                </div>
              </div>
