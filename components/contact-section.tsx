          ...
          >
            <div>
              ...
              <p className="text-white/70 leading-relaxed">
                Whether you want to speak at an event, sponsor our meetup, or
                just connect with the community, we&apos;re here to help.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/60">hello@tampaawsmeetup.com</p>
                </div>
              </div>
